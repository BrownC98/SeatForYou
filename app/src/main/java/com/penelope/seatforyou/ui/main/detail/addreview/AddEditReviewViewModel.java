...
@HiltViewModel
public class AddEditReviewViewModel extends ViewModel implements FirebaseAuth.AuthStateListener {
    ...
    @Inject
    public AddEditReviewViewModel(SavedStateHandle savedStateHandle, ReviewRepository reviewRepository) {
    ...
    public void onSubmitClick() {
        ...
        reviewRepository.addReview(review,
                unused -> event.setValue(new Event.NavigateBackWithResult(oldReview == null)),
                e -> {
                    e.printStackTrace();
