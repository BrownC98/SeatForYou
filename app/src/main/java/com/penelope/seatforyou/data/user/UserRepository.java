...
public class UserRepository extends BaseRepository<User> {
    ...
    public void addRemoveDib(String uid, String shopId, OnSuccessListener<Boolean> onSuccessListener, OnFailureListener onFailureListener) {
        getUser(uid,
                user -> {
                    if (user == null) {
                    ...
                    boolean contains = user.getDibs().contains(shopId);
                    ...
                    userCollection.document(uid)
                            .set(user)
                            .addOnSuccessListener(unused -> onSuccessListener.onSuccess(!contains))
                            .addOnFailureListener(onFailureListener);
                },
                onFailureListener);
    }
